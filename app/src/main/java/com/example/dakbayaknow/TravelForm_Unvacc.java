...
public class TravelForm_Unvacc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_travelform_unvacc);
        ...
        departureText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        TravelForm_Unvacc.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, setListener, year, month, day);
        ...
        arrivalText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog2 = new DatePickerDialog(
                        TravelForm_Unvacc.this, android.R.style.Theme_Holo_Light_Dialog_MinWidth, setListener2, year2, month2, day2);
