...
public class AdapterClassUnVacc extends FirebaseRecyclerAdapter<Requirements, AdapterClassUnVacc.myViewHolder> {

    public AdapterClassUnVacc(@NonNull FirebaseRecyclerOptions<Requirements> options) {
        super(options);
    }
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_holder_unvacc, parent, false);
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") int position, @NonNull Requirements model) {
        holder.Req1.setText(model.getuVaccReq1());
        holder.Req2.setText(model.getuVaccReq2());
        holder.Req3.setText(model.getuVaccReq3());
        holder.Req4.setText(model.getuVaccReq4());
        holder.Req5.setText(model.getuVaccReq5());
