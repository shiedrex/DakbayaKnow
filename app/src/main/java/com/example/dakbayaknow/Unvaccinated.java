                ...
                ref.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()) {
                            ...
                            Toast.makeText(Unvaccinated.this, "Please fill up HDF first", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(Unvaccinated.this, HealthDeclarationForm.class);
